...
from Models.TrainerDefinitivo import TrainerDefinitivo as model_10min
...
def run_and_get_metrics():
    models = {
        "10min": model_10min.train_and_evaluate(varbose=False),
        "15min": model_15min.train_and_evaluate(varbose=False),
        "20min": model_20min.train_and_evaluate(varbose=False),
        "25min": model_25min.train_and_evaluate(varbose=False),
        "30min": model_30min.train_and_evaluate(varbose=False),
    }
