...
from Models import TrainerDefinitivo15Min as model_15min
from Models import TrainerDefinitivo20Min as model_20min
from Models import TrainerDefinitivo25Min as model_25min
from Models import TrainerDefinitivo30Min as model_30min

def run_and_get_metrics():
    models = {
        "10min": model_10min.train_and_evaluate(verbose=True),
