!function() {
    ...
    function e(t, e) {
        if (/^localhost$|^127(\.[0-9]+){0,2}\.[0-9]+$|^\[::1?\]$/.test(i.hostname) || "file:" === i.protocol) return s("localhost", e);
        ...
        var n = {},
            t = (n.n = t, e && e.u),
            a = (n.u = t || i.href, n.d = l, n.r = r.referrer || null, e && e.meta && (n.m = JSON.stringify(e.meta)), e && e.props && (n.p = e.props), new XMLHttpRequest);
        a.open("POST", o, !0);
    ...
    window.plausible = e;    for (var a = 0; a < n.length; a++) e.apply(this, n[a]);
}();