    ...
    <div class="wrapper">
        ...
        <div class="content">
            ...
            <div class="profileContainer">
                ...
                <div class="userSection" id="buttonSection">
                    <button id="editButton" class="button" type="button">Modifica Profilo</button>
                    <button id="deleteButton" class="button" type="button">Elimina Profilo</button>
            </div>
        </div>
