                ...
                <div class="userSection" id="textSection">
                    <form class="UpdateForm" action="update_profile.php" method="post">
                        <div>
                            ...
                            <input type="text" id="lastname" name="lastname" value="<?php echo htmlentities($surname); ?>">
                            ...
                            <select name="genere" id="genere" value="<?php echo htmlentities($genere); ?>">
                            ...
                            <textarea id="descrizione" name="descrizione" value="<?php echo htmlentities($descrizione); ?>">></textarea>
                        </div>
