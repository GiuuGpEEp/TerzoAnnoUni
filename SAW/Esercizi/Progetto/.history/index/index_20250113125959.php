...
<html lang="en">
    ...
    <body>
        ...
        <div id="mainContent">
            ...
            <div id="SubsSection">
                <p id="subsTitle" class="Sottotitoli"> Per restare </p>
                <p id="subsDescription" class="Descrizioni"> Iscriviti alla newsletter per rimanere aggiornato su tutte le n</p>
