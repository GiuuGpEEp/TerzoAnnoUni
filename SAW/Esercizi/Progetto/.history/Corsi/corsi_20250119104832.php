...
if(!isset($_SESSION['username']) ){
    ...
    $buttonClass = "prenotationButtonLogin"; nmkm,.zsazs.l,cxòpko, xsax.
}
...
<script>
    ...
    const buttonClass = "<?php echo $buttonClass; ?>"; // Classe del bottone
        ...
        .then(data => {
            ...
            data.forEach(corso => {
                ...
                container.innerHTML = `
                    ...
                    <button class="<?php echo $buttonClass; ?>">Prenotati</button>`;
