    ...
    function caricaCorsi(url) {
        fetch(url)
            ...
            .then(data => {
                ...
                const titoli = data.titoliSezione;
                colonnaBambini.innerHTML = `<div class="corsoTitle">${titoli.bambini}</div>`;
                colonnaRagazzi.innerHTML = `<div class="corsoTitle">${titoli.ragazzi}</div>`;
                colonnaAdulti.innerHTML = `<div class="corsoTitle">${titoli.adulti}</div>`;
