    ...
    <div class="wrapper">
        ...
        <div class="content">
            ...
            <div class="contactANDForm">
                <div class="contactSection"></div>                    
                <div class="formSection">
                    <div class="formTitle">Compila il form sottostante <br> per inviarci un messaggio</div>
                    <form action="contactForm.php" method="post">
                        ...
                        <textarea id="message" name="message" maxlength="500" required style="resize: vertical; height: 150px;"></textarea>
